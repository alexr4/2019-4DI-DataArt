...
void setup() {
 ...
 // size(1000, 3000, P2D);
  ...
  videoExport = new VideoExport(this, "SolineLoopedNoise3.mp4");
...
void draw() {
  ...
  for (int i = 0; i<arbres.size(); i++) {
    ...
    /* 
     ...
     72.6°, 72.4, 82.4
     */
    float hue =  map(numberOfTrees, minmax[0], minmax[1], 90, 330);
    float sat =  map(numberOfTrees, minmax[0], minmax[1], 10, 55);
    float brigh =  map(numberOfTrees, minmax[0], minmax[1], 85, 50  );
